...
const Header = () => {
    ...
    const counter = useSelector(state => state.basketChenge.count)
    const newArr = useSelector(state => state.basketChenge.shopingArr)
// Нажатие на корзину
    ...
    return (
        ...
        <header className=' bg-hunter-green shadow-sm'>
            ...
            {ShowItemCart ? <ItemCart changeState={setShowItemCart}/> : null}    
        </header>
